    ...
    return (
        <div className="flex flex-col items-center justify-center py-5 px-5 sm:px-10 md:px-16 sm:py-10 md:py-20   ">
            <div className="w-full  flex flex-wrap flex-row items-center justify-center">
                {/* Single Card */}
                <div className="flex flex-col items-center justify-center min-w-[160px] max-w-[400px] w-1/2 p-4">
                    <div
                    ...
                    >
                        <div className="absolute bottom-5 left-5 text-white text-lg font-semibold px-2 py-1 rounded">
                            <p className="text-xl sm:text-2xl md:text-3xl xl:text-4xl raleway-bold">low taper</p>
                        </div>
                    </div>
                </div>
                <div className="flex flex-col items-center justify-center min-w-[160px] max-w-[400px] w-1/2 p-4">
